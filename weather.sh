...
cat final.csv | tail --lines=+2 | tr '"' ' ' | tr ' ' ',' | sed 's/,,/,/g' | cut -d',' -f2,98,100,101,102,103,104,117,126,128,130,133 | LC_NUMERIC="C" awk 'BEGIN{FS=OFS=","}{ print $1,$3-273.15,$5,$4-273.15,sqrt(($6*$6)+($7*$7))*3.6,atan2($7,$6)*180/3.14,$8,$2,$9,$10,$11,$12 }'  >> meteo.csv
